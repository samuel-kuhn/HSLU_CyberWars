...
sqlite3 /home/$WEBADMIN_USERNAME/backend-api/data/employees.db < backend-api/db-setup.sql
...
docker compose -f /home/$WEBADMIN_USERNAME/backend-api/docker-compose.yml up -d
